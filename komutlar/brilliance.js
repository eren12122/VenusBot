...
Jimp.read(user.avatarURL, (err, image) => {
    ...
    Jimp.read("https://api.eggsybot.xyz/api/cerceve?cerceve=brilliance&url=https://api.eggsybot.xyz/pub/resources/frames/brilliance.png", (err, avatar) => {
        ...
        image.composite(avatar, 0, 0).write(`./img/brilliance/brilliance.png`);
        setTimeout(function() {
            message.channel.send(new Discord.Attachment(`./img/brilliance/brilliance.png`));
        }, 1000);
    });
...
exports.conf = {
  ...
  exports.help = {
    name: 'brilliance',
    description: 'Avatarınıza Brilliance Efekti Ekler.',
    usage: 'brilliance'
  };